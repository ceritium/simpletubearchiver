...
# docker build -t simpletuvearchiver .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name simpletuvearchiver simpletuvearchiver
#
# For local development without SSL (to fix form submissions), add -e DISABLE_SSL=true:
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> -e DISABLE_SSL=true --name simpletuvearchiver simpletuvearchiver
